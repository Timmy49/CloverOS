...
def location_action():
  ...
  while True:
    ...
    # Special Actions
      ...
      if "scraps" in bonnet_action or "metal scraps" in bonnet_action:
        ...
        if player_x == 3 and player_y == 1:
          ...
          print("You cannot find anything here.")
          location_text()
          location_action()
      else:
        print("You cannot search there.")
        location_text()
        location_action()
...
def bonnet_pre_setup():
  global player_x, player_y, false_player_x, false_player_y, inventory_str, progress_str, inventory_gui, progress_gui, developer_mode, bonnet_admin_complex
  developer_mode = False
  bonnet_admin_complex = False
  player_x = 1
  player_y = 1
